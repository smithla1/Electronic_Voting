/*
 * UserInterface.java is a 1.4 example that requires
 * no other files.
 */
import javax.swing.*;
import java.awt.*;
...
public class UserInterface extends JPanel {
    ...
    JCheckBox dialogCheckBox;
    private boolean showDialog; //if true show dialog, otherwise don't
    ...
    public UserInterface(JFrame frame) {
        ...
        //set showDialog to true as default
        showDialog = true;
        ...
        System.out.println("passed dialogCheckBox creation");
        ...
        add(dialogCheckBox, BorderLayout.EAST);       
    ...
    private JPanel createSimpleDialogBox() {
        ...
        //final String defaultSelectCommand = "clicked";
        dialogCheckBox = new JCheckBox("Show Dialog");
        dialogCheckBox.setSelected(true);
        //showDialogCheckBox.setActionCommand(defaultSelectCommand);
        dialogCheckBox.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
    ...
    private static void createAndShowGUI() {
        ...
        contentPane.add(new UserInterface(frame));
